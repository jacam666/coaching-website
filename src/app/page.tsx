...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-white px-4">
      <Navbar />
      {/* Hero Section */}
      <section className="py-10 flex flex-col items-center justify-center gap-8 w-full max-w-5xl mx-auto bg-white rounded-xl">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <Link
            href="/about"
            className="inline-block  text-green-900 px-8 py-3 rounded-full text-lg font-semibold transition duration-300 hover:bg-green-300 border-2 border-green-300 hover:border-green-500"
          >
            Learn more about me
          </Link>
        </div>
      ...
      <section id="contact" className="w-full max-w-xl rounded-xl my-8 md:my-0  py-12">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-4  rounded-xl p-8">
          ...
          <button
            type="submit"
            className={`px-6 py-2 rounded-full font-semibold transition text-lg ${sent ? "bg-green-600 text-white" : " text-green-900 hover:bg-green-300 border-2 border-green-300 hover:border-green-500"}`}
